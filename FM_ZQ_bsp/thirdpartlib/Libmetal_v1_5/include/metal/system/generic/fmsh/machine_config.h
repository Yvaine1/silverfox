...
/*
 * @file	generic/fmsh/machine_config.h
...
// 													(void *)pa; })
*/
#define Machine_MemMap(pa, size, flags)	((void)size, (void)flags, (void *)pa)
...
/* libmetal interface */
#define Machine_EnableIntr(vector)	FGicPs_EnableIntr(FPAR_SCUGIC_DIST_BASEADDR, vector)
#define Machine_DisableIntr(vector)	FGicPs_DisableIntr(FPAR_SCUGIC_DIST_BASEADDR, vector)
