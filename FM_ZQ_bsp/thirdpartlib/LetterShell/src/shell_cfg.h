 ...
 */
    ...
    #define     SHELL_DEFAULT_USER          "A53"
#elif SHELL_CMD_MASTER == 1
    #define     SHELL_DEFAULT_USER          "R50"
#elif SHELL_CMD_MASTER == 2
    #define     SHELL_DEFAULT_USER          "R51"
#endif
...
#define SHELL_WORK_BUFFER_SIZE   512
#define SHELL_WORK_OUT_BUFFER_SIZE  4096
#define SHELL_HOSTNAME_SIZE     16
#define SHELL_CMD_RESP_BUFFER_SIZE  1024
