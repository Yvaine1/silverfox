...
u32 XRFdc_GetInterpolationFactor(XRFdc *InstancePtr, u32 Tile_Id, u32 Block_Id, u32 *InterpolationFactorPtr)
{
	...
	FMSH_ASSERT(InstancePtr != NULL);
	FMSH_ASSERT(InterpolationFactorPtr != NULL);
	FMSH_ASSERT(InstancePtr->IsReady == XRFDC_COMPONENT_IS_READY);
					...
					u32 Channel)
{
	...
	FMSH_ASSERT(InstancePtr != NULL);
	FMSH_ASSERT(DecimationFactorPtr != NULL);
	FMSH_ASSERT(InstancePtr->IsReady == XRFDC_COMPONENT_IS_READY);
				     ...
				     u32 Channel)
{
	...
	FMSH_ASSERT(InstancePtr != NULL);
	FMSH_ASSERT(FabricWrVldWordsPtr != NULL);
	FMSH_ASSERT(InstancePtr->IsReady == XRFDC_COMPONENT_IS_READY);
				     ...
				     u32 Channel)
{
	...
	FMSH_ASSERT(InstancePtr != NULL);
	FMSH_ASSERT(FabricRdVldWordsPtr != NULL);
	FMSH_ASSERT(InstancePtr->IsReady == XRFDC_COMPONENT_IS_READY);
