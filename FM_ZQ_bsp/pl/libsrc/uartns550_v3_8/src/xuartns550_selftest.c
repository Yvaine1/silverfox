...
* 2.01a bss  01/13/12 Updated the XUartNs550_SelfTest to use FMSH_ASSERT
...
* @return
*
* 		- FMSH_SUCCESS if the test was successful
...
int XUartNs550_SelfTest(XUartNs550 *InstancePtr)
{
	 ...
	 * register
	 */
	McrRegister = FMSH_ReadReg(InstancePtr->BaseAddress,
						XUN_MCR_OFFSET);
	FMSH_WriteReg(InstancePtr->BaseAddress, XUN_MCR_OFFSET,
