...
static inline uint32_t CH9_ConfigParamsSF(const CH9_ConfigParams *obj);
static inline uint32_t CH9_Usb20ExtensionDescriptorSF(
    const CH9_Usb20ExtensionDescriptor *obj);
static inline uint32_t CH9_UsbBosDescriptorSF(const CH9_UsbBosDescriptor *obj);
static inline uint32_t CH9_UsbCapabilityDescriptorSF(
    const CH9_UsbCapabilityDescriptor *obj);
static inline uint32_t CH9_UsbConfigurationDescriptSF(
    const CH9_UsbConfigurationDescriptor *obj);
static inline uint32_t CH9_UsbContainerIdDescriptorSF(
    const CH9_UsbContainerIdDescriptor *obj);
static inline uint32_t CH9_UsbDeviceDescriptorSF(
    const CH9_UsbDeviceDescriptor *obj);
static inline uint32_t CH9_UsbDeviceQualifierDescriSF(
    const CH9_UsbDeviceQualifierDescriptor *obj);
static inline uint32_t CH9_UsbEndpointDescriptorSF(
    const CH9_UsbEndpointDescriptor *obj);
static inline uint32_t CH9_UsbHeaderDescriptorSF(
    const CH9_UsbHeaderDescriptor *obj);
static inline uint32_t CH9_UsbInterfaceAssociationDSF(
    const CH9_UsbInterfaceAssociationDescriptor *obj);
static inline uint32_t CH9_UsbInterfaceDescriptorSF(
    const CH9_UsbInterfaceDescriptor *obj);
static inline uint32_t CH9_UsbOtgDescriptorSF(const CH9_UsbOtgDescriptor *obj);
static inline uint32_t CH9_UsbOtherSpeedConfiguratiSF(
    const CH9_UsbOtherSpeedConfigurationDescriptor *obj);
static inline uint32_t CH9_UsbPTMCapabilityDescriptSF(
    const CH9_UsbPTMCapabilityDescriptor *obj);
static inline uint32_t CH9_UsbPlatformDescriptorSF(
    const CH9_UsbPlatformDescriptor *obj);
static inline uint32_t CH9_UsbSSDeviceCapabilityDesSF(
    const CH9_UsbSSDeviceCapabilityDescriptor *obj);
static inline uint32_t CH9_UsbSSEndpointCompanionDeSF(
    const CH9_UsbSSEndpointCompanionDescriptor *obj);
static inline uint32_t CH9_UsbSSPlusDescriptorSF(
    const CH9_UsbSSPlusDescriptor *obj);
static inline uint32_t CH9_UsbSSPlusIsocEndpointComSF(
    const CH9_UsbSSPlusIsocEndpointCompanionDescriptor *obj);
static inline uint32_t CH9_UsbSetupSF(const CH9_UsbSetup *obj);
static inline uint32_t CH9_UsbStringDescriptorSF(
    const CH9_UsbStringDescriptor *obj);
