...
// possession of a valid End User License Agreement for the Arm Product of which
// these examples are part of and your compliance with all applicable terms and
...
#define TT_S1_ATTR_nT \
    (1 << 16)  // Present if Armv8.4-TTRem is implemented, otherwise RES0

#define TT_S1_ATTR_DBM \
    (1 << 51)  // Present if Armv8.1-TTHM is implemented, otherwise RES0

#define TT_S1_ATTR_CONTIG       (1 << 52)
#define TT_S1_ATTR_PXN          (1 << 53)
#define TT_S1_ATTR_UXN          (1 << 54)

// PBHA bits[62:59] - If Armv8.2-TTPBHA is implemented, hardware can use these
// bits for IMPLEMENTATIONDEFINED purposes, otherwise IGNORED
